...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'pros-cons',
        loadComponent: () =>
          import('./pages/prosConsPage/prosConsPage.component'),
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './pages/prosConsStreamPage/prosConsStreamPage.component'
          ),
        data: {
...

      {
        path: 'assistant',
        loadComponent: () =>
          import('./pages/assistantPage/assistantPage.component'),
        data: {
